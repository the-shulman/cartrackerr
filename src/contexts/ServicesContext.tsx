...
interface ServicesContextType {
  services: Service[];
  addService: (serviceData: Omit<Service, 'id' | 'createdAt' | 'updatedAt' | 'status'>) => void;
  updateStatus: (id: string, newStatus: ServiceStatus) => void;
  addDiagnosticReport: (id: string, report: DiagnosticReport) => void;
  approveServices: (id: string, approvedItemIds: string[], clientNotes?: string) => void;
